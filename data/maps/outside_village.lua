...
local function  talk_to_kids() 
      ...
      if rand == 1 then
        map:start_dialog("village_des_mouettes.kids_1")
      end
      if rand == 2 then
        map:start_dialog("village_des_mouettes.kids_2")
      end
      if rand == 3 then
        map:start_dialog("village_des_mouettes.kids_3")
      end
      if rand == 4 then
        map:start_dialog("village_des_mouettes.kids_4")
      end
